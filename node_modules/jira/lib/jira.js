...
var JiraApi = exports.JiraApi = function(protocol, host, port, username, password, apiVersion, verbose, strictSSL, pref, oauth) {
console.log(pref);
    ...
    this.makeUri = function(pathname, altBase, altApiVersion) {
        var basePath = this.pref + 'rest/api/';
        if (altBase != null) {
            basePath = altBase;
        }
    ...
    this.findIssue = function(issueNumber, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (response.statusCode === 404) {
                callback('Invalid issue number.' + options.uri);
                return;
            }
